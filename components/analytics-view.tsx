...
const ACHIEVEMENT_ICONS = [Award, ShieldCheck, TrendingDown];

const SUMMARY_CARDS = [
  ["Average calories", "2,441", "kcal/day"],
  ["Goal achievement", "84%", "last 14 days"],
  ["Protein consistency", "11/14", "days above 140g"],
  ["Best streak", "12", "days"]
] as const;

const WEEKLY_REPORT_ROWS = [
  ["Average calories", "2,441 kcal"],
  ["Average protein", "147g"],
  ["Average weight", "89.9kg"],
  ["Weight change", "-0.6kg"],
  ["Goal adherence", "84%"]
] as const;
      ...
      <section className="grid gap-4 lg:grid-cols-[0.7fr_1.3fr]">
        <Card>
          ...
          <CardContent className="grid gap-3">
            {WEEKLY_REPORT_ROWS.map(([label, value]) => (
